...
interface ChapterEntryDeleteDialogProps {
  entry: ChapterEntry;
  categories: Category[];
  onConfirm: () => void;
  onClose: () => void;
...
export const ChapterEntryDeleteDialog = ({
  entry,
  categories,
  onConfirm,
  onClose,
}: ChapterEntryDeleteDialogProps) => {
  ...
  return (
    ...
    >
      ...
      <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="delete-chapter-entry-title"
      ...
      >
        ...
        <div className="px-4 py-4">
          <p className="text-[13px] leading-relaxed text-muted-foreground">
            This removes the expense from this chapter and the cloud.
          </p>
